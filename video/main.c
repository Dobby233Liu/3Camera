...
int main() {
	...
	printf("Loading... Inistialting the Nintendo 3DS's camera !\n");
	...
	if(!buf) {
		hang("Oh oh... Failed to allocate memory!");
	}
	...
	printf("\nUse slider to enable 3D. Make 3D videos !\n");
